...
export function CaregiverPhone() {
  ...
  const validate = () => {
    ...
    else if (digits.length < 10 || digits.length > 11) errs.caregiverPhone = 'Please make sure your phone number is 10 digits long (including area code) or 11 digits long (including country code) and does not contain any special characters'
    return errs
  }
    ...
    <div className="screen">
      ...
      <form className="screen-body" onSubmit={handleSubmit} noValidate>
        <div className="screen-content">
          <BackButton onClick={() => navigate('/register/caregiver-address')} />
          ...
          <div className="form">
            <div className="fields">
              <TextField
                ...
                onChange={e => update({ caregiverPhone: formatPhone(e.target.value) })}
