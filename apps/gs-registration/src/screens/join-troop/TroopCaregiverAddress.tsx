...
import '../../screens/CaregiverAddress.css'

export function TroopCaregiverAddress() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    navigate('/join-troop/caregiver-phone')
  }
    ...
    <div className="screen">
      ...
      <form className="screen-body" onSubmit={handleSubmit} noValidate>
        <div className="screen-content">
          <BackButton onClick={() => navigate('/join-troop/caregiver-email')} />
